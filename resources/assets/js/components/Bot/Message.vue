        ...
        <div class="card-content">
            ...
            <blockquote v-if="message.type === 'file'">
                <a :href="message.message">
                    <i class="material-icons">attach_file</i>Arquivo para download
                </a>
            </blockquote>

            <form @submit.prevent="update(currentMessage)" v-if="showEditForm">
                <div class="input-field">
                    <input type="text" class="form-control" placeholder="Mensagem ou rl ..." v-model="currentMessage" required>
                </div>
