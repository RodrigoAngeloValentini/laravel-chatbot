export default {
    ...
    actions: {
        ...
        addGetStarted (context , id){
            return window.axios.post('api/v1/messages/get-started-button/' + id)
        },
        removeGetStarted (context , id){
            return window.axios.delete('api/v1/messages/get-started-button/' + id)
        }
    }
}